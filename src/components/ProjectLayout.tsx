...
export default function ProjectLayout({
  ...
  return (
    <main className="min-h-screen bg-white text-black flex flex-col md:flex-row overflow-x-hidden pb-32 md:pb-0">
      ...
      <div className={`w-full ${hideRightPanel ? "md:w-full min-h-screen" : "md:w-1/2"} md:fixed md:left-0 md:top-0 md:h-screen flex flex-col justify-between pt-4 pb-8 px-8 ${hideRightPanel ? "md:py-24" : "md:pt-[100px] md:pb-24"} md:px-24 lg:pl-[176px] bg-white z-10 ${!hideRightPanel ? "border-r border-zinc-100" : ""}`}>
