      ...
      <div className="w-full md:w-1/2 flex flex-col justify-between p-8 md:p-24 lg:pl-44 min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center py-20">
          ...
          <div className="text-xl opacity-80 max-w-lg leading-relaxed space-y-4">
            <p>
              Lack of mobility and existence in the digital scene and inadequate conversion, 
              especially during Covid-19 year, alongside the adaptation to different types of users.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-8 mt-auto">
          <div className="flex items-center gap-6 text-3xl">
            <Link href="/projects/delek" className="hover:-translate-x-1 transition-transform text-black">←</Link>
